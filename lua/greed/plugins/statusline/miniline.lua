...
local my_utils = require("greed.plugins.statusline.utils")
...
local numOfDiag = function(args)
	...
	if count == nil or mini_utils.diagnostic_is_disabled() then
		return ""
	end
...
local groups = {
	...
	arrow_left,
	{ priority = 5, string = { fn.fileNameShort }, hl_fn = hl.filename },
	{
		priority = 4,
		string = function()
			return fn.fileStatus({ prefix = " " })
		end,
		hl_fn = hl.filestatus,
	},
	arrow_right,
	{
		...
		hl = color_suffix .. "FgViolet",
	},
	{
		priority = 9,
		string = function()
			return fn.gitDiffInfo({ prefix = " " })
		end,
	},
	align,
	...
	-- {priority = 10, string = diagnostics},
	{
		priority = 13,
		string = function()
			return " " .. numOfDiag({ severity = "ERROR" })
		end,
		hl = "DiagnosticError",
	},
	{
		priority = 12,
		string = function()
			return numOfDiag({ severity = "WARN", prefix = " " })
		end,
		hl = "DiagnosticWarn",
	},
	{
		priority = 11,
		string = function()
			return numOfDiag({ severity = "INFO", prefix = " " })
		end,
		hl = "DiagnosticInfo",
	},
	{
		priority = 10,
		string = function()
			return numOfDiag({ severity = "HINT", prefix = " " })
		end,
		hl = "DiagnosticHint",
	},
	align,
	...
	{
		string = function()
			return file_info.type({ prefix = " " })
		end,
		hl = color_suffix .. "FgBlue",
	},
	{
		string = function()
			return fn.fileSize({ prefix = " " })
		end,
		hl = color_suffix .. "FgYellow",
	},
	{
		string = function()
			return fn.fileEncoding({ prefix = " " })
		end,
		hl = color_suffix .. "FgCream",
	},
	{
		string = function()
			return fn.fileFormat({ prefix = " " })
		end,
		hl_fn = hl.mode,
	},
	space,
