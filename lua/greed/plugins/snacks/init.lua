return {
	...
	---@type snacks.Config
	opts = {
		dashboard = require("greed.plugins.snacks.dashboard"),
		indent = require("greed.plugins.snacks.indent"),
		picker = require("greed.plugins.snacks.picker"),
		terminal = require("greed.plugins.snacks.terminal"),
		statuscolumn = require("greed.plugins.snacks.statuscolumn"),
		notifier = {
			enabled = true,
			top_down = false,
	...
	keys = require("greed.plugins.snacks.keymaps"),
}
