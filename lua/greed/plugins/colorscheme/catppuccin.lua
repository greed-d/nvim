return {
	...
	config = function()
		...
		set_highlight("NormalFloat", { bg = mocha.base })
		...
		set_highlight(
			"MiniTablineCurrent",
			{ bg = mocha.surface0, fg = mocha.subtext1, cterm = { italic = true, bold = true } }
		)
		set_highlight("GitSignsCurrentLineBlame", { fg = mocha.overlay0 })
	end,
}
