...
-- stylua: ignore
    ...
    ins_left({
      ...
      color = function()
        ...
        return { bg = mode_color[vim.fn.mode()], fg = colors.gray, gui = "bold" }
      end,
    ...
    ins_left({
      my_filename,
      -- cond = conditions.buffer_not_empty,
      color = { fg = colors.magenta, bg = colors.gray, gui = "bold" },
    })
    ...
    ins_right({
      ...
      color = function()
        ...
        if position <= 5 then
          return { fg = colors.aqua, gui = "bold", bg = colors.gray }
        elseif position >= 95 then
          return { fg = colors.red, gui = "bold", bg = colors.gray }
        else
          return { fg = colors.purple, bg = colors.gray, gui = "bold" }
        end
      end,
    })
